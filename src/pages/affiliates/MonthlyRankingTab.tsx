...
interface MonthlyRankingTabProps {
  rankingData: RankingItem[];
}

const MonthlyRankingTab: React.FC<MonthlyRankingTabProps> = ({ rankingData }) => {
              ...
              <TableRow>
                <TableCell colSpan={5} className="text-center py-12 text-muted-foreground">
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-lg">Nenhum dado de venda registrado para este mês</p>
                  </div>
                </TableCell>
              </TableRow>
            )}
...
export default MonthlyRankingTab;
